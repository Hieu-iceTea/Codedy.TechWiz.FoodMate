                        ...
                        <div class="slick-slider">
                            <div>
                                <div
                                    ...
                                    <div class="slide-img-bg"
                                         style="background-image: url('../dashboard/assets/images/originals/food-1.jpg');"></div>
                                    <div class="slider-content">
                                        <h3>Crispy Baked Falafel</h3>
                                        <p>
                                            We had them with whole wheat pita, hummus, vegan pesto mayo, tomatoes,
                                            kalamata olives and spring greens.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div>
                                <div
                                    ...
                                    tabindex="-1">
                                    <div class="slide-img-bg"
                                         style="background-image: url('../dashboard/assets/images/originals/food-2.jpg');"></div>
                                    <div class="slider-content">
                                        <h3>Black Bean Sweet Potato Enchiladas</h3>
                                        <p>
                                            I paired it with Cilantro Lime Rice – perfection. I’m going to be whipping
                                            up more of your recipes this coming week. Thank you, Kate!
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div>
                                <div
                                    ...
                                    tabindex="-1">
                                    <div class="slide-img-bg"
                                         style="background-image: url('../dashboard/assets/images/originals/food-3.jpg');"></div>
                                    <div class="slider-content">
                                        <h3>Best Lentil Soup</h3>
                                        <p>
                                            This is one of my favorite recipes ever. I think I could eat it every day.
                                            After every single bite. The curry powder and lemon
                                            juice MAKE IT.
                                        </p>
                                    </div>
                                </div>
