...
# SET @DATABASE_Name = 'epiz_29739290_Codedy_TechWiz_FoodMate';

# Create DataBase
DROP DATABASE IF EXISTS `epiz_29739290_Codedy_TechWiz_FoodMate`;
CREATE DATABASE IF NOT EXISTS `epiz_29739290_Codedy_TechWiz_FoodMate` CHARACTER SET utf8 COLLATE utf8_unicode_ci;

USE `epiz_29739290_Codedy_TechWiz_FoodMate`;

SET time_zone = '+07:00';
ALTER DATABASE `epiz_29739290_Codedy_TechWiz_FoodMate` CHARACTER SET utf8 COLLATE utf8_unicode_ci;
