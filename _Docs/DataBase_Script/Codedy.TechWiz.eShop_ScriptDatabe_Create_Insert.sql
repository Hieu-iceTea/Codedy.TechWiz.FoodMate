...
VALUE (9, 'Host', 'host.codedy@gmail.com', '$2y$10$oW..IGNT/CH2muKpN/8LAuNJ1ahnwLoyCBWRQyBj4p6ITOJFb.gs2', 1, '2020-08-08', 'host.jpg', 1, 'CODEDY', 'Host', '032 87 99 000', '8, Ton That Thuyet, Ha Noi, Viet Nam', TRUE);
INSERT INTO User (id, user_name, email, password, level, email_verified_at, image, gender, first_name, last_name, phone, address, active)
VALUE (8, 'Admin', 'admin.codedy@gmail.com', '$2y$10$/AmOQGhkVS8otOSJbAv.6OHxseW/AOdVw7wxNbopMHgy0Btbp3Anu', 2, '2020-08-08', 'admin.jpg', 1, 'CODEDY', 'Admin', '0868 6633 15', '8, Ton That Thuyet, Ha Noi, Viet Nam', TRUE);
INSERT INTO User (id, user_name, email, password, level, email_verified_at, image, gender, first_name, last_name, phone, address, active)
VALUE (7, 'Staff', 'staff.codedy@gmail.com', '$2y$10$//Od0OmEqRwFepW3wynrYOwslyvaS.snzBbpWwskF1Zrg5fNI.eTe', 3, '2020-08-08', 'staff.jpg', 2, 'CODEDY', 'Staff', '0868 6633 15', '8, Ton That Thuyet, Ha Noi, Viet Nam', TRUE);
INSERT INTO User (id, user_name, email, password, level, email_verified_at, image, gender, first_name, last_name, phone, address, active)
...
VALUE (19, 4, 1, 'Anitas Cantina', 'Beef, cheese, potato, onion, fries',32.5, 'AnitasCantina.jpg', 'Mexico', 'Breakfast', 'serves up fresh, authentic Tex-Mex made with lots of love', TRUE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (45, 8, 9, 'Baked Salmon Roll', 'salmon and cheese',18.90, 'baked-salmon-roll.jpg', 'American', 'Lunch', 'Grilled salmon with special sauce and cheese topped with a new flavor and california wrap create an eye-catching feeling for sushi.', TRUE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (29, 5, 2, 'BBQ Brekky Stack', 'Beef, cheese, potato, onion, fries',39.59, 'BBQ_Brekky_Stack.jpg', 'American', 'Dinner', 'Golden hash brown, two slices of premium eye bacon, a freshly cracked egg, cheese and tangy BBQ sauce stacked high on a sesame seed bun. Available until 11am.', FALSE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (1, 1, 1, 'Best Lentil Soup', 'Gluten free and vegan',39.90, 'Best Lentil Soup.jpg', 'Viet Nam', 'Snacks', 'This is one of my favorite recipes ever. I think I could eat it every day. One time when I was eating it while curled up on the couch, I kept saying, “This is sooo good,” after every single bite. The curry powder and lemon juice MAKE IT. Thank you, Kate!', TRUE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
...
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (34, 6, 7, 'Cacio Pepe', 'Black Pepper, Pecorino and Butter',39.59, 'CacioPepe.jpg', 'Chinese', 'Lunch', 'This sauce, although not strictly traditional, combines the classic ingredients of several regions of Italy: Calabria and Campania in the south and Lombardia in the north. Calabrian ‘nduja sausage, citrus celebrated in Campania, and mascarpone originating in Lombardia come together in this irresistible dish. The spicy and soft ‘nduja sausage forms the perfect base for this sauce', FALSE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (46, 8, 1, 'California Rool', 'Rice and butter',25.90, 'california-roll.jpg', 'ThaiLan', 'Dinner', 'Rice and avocado create a novel combination for sushi. With familiar ingredients, but this novel combination will bring everyone delicious and attractive sushi dishes ', FALSE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (59, 10, 5, 'Cocktail Cafe', 'Beef, cheese, potato, onion, fries',27.8, 'CocktailCafe.jpg', 'Korean', 'Snacks', 'A cocktail is an alcoholic mixed drink, which is either a combination of spirits, or one or more spirits mixed with other ingredients such as fruit juice, flavored syrup, or cream.', FALSE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (33, 6, 6, 'Garganelli', 'Mushroom Ragu and Ricotta Salata',29.90, 'creamy-cacio-e-pepe-recipe-2150w.jpg', 'Chinese', 'Breakfast', 'Now very much a favourite amongst the Pasta Evangelists community – and something of a signature dish – this hedonistic Roman classic is thought to have its name derived from when charcoal burners were used to cook the dish over campfires. In true Pasta Evangelists style, we’ve added our own twist to this classic, comforting dish, presenting a gloriously creamy carbonara with tangles of fresh bucatini – in our opinion bigger and better than spaghetti – which sop up this luxuriant sauce.', FALSE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (2, 1, 2, 'Crispy Baked Falafel', 'Vegetables and wheat',49.90, 'Crispy Baked Falafel.jpg', 'American', 'Lunch', 'Ok, these little babies are literally THE best falafels I have EVER had. I will be keeping this recipe, five out of five!! We had them with whole wheat pita, hummus, vegan pesto mayo, tomatoes, kalamata olives and spring greens. OMG sooo good. Thank You!!! You’re the best! I could cry they are so good!', TRUE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (26, 5, 8, 'Croissanwich Meal for Two', 'Beef, cheese, potato, onion, fries',39.90, 'Croissa.jpg', 'American', 'Dinner', '2 Croissanwich Sandwiches, 2 Small Hash Browns, 2 Small Brewed Coffees', FALSE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (50, 9, 5, 'Cheap Corner', 'Beef, cheese, potato, onion, fries',17.3, 'CheapCorner.jpg', 'VietNam', 'Snacks', 'Product Description. If you are looking for comfort, style and competitive prices youve found the right sofa for you', TRUE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (40, 7, 4, 'Cheese Pizza', 'Tomato sauce, mozzarella and provolone.',11.90, 'cheese-pizza.jpg', 'Japan', 'Breakfast', 'Cheese pizza uses cheese as the main flavor to make a difference to the cake and create a new impression on the eaters.', FALSE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (15, 3, 6, 'Chiayi Chicken Rice', 'Jidori chicken, shallot oil, house pickles,
garnished with scallions. Gluten Free',6.90, 'chiayi-chicken-rice.jpg', 'Korean', 'Lunch', 'Vegetarian noodles are full of delicious spices, giving diners a delicious and attractive dish', FALSE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (23, 4, 5, 'Chicken Tacos', '1 large red onion, diced (reserve half)
500g chicken mince
30g Old El Paso™ Taco Spice Mix
1/2 cup water
1/2 cup Old El Paso™ Mild Taco Sauce',34.5, 'ChickenTacos.jpg', 'Mexico', 'Dinner', 'n a small bowl, combine chili powder, cumin, paprika, oregano, garlic powder, 1 teaspoon salt and 1/2 teaspoon pepper. Season chicken with chili powder mixture. Heat canola oil in a large skillet over medium high heat. Serve chicken in tortillas, topped with pico de gallo, avocado, cilantro and lime', FALSE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (32, 6, 5, 'Bucatini', 'Pancetta, Tomato, Chilies and Pecorino',49.90, 'delish-bucatinipasta.jpg', 'Chinese', 'Snacks', 'The beautiful, rolling hills of Tuscany are home to countless vineyards and the region is fondly nicknamed ‘Chiantishire’ after the bold red wine that it produces in abundance. However, it is not only for its wine that this region is so well-loved.', FALSE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (54, 9, 9, 'Dessert Place', 'Beef, cheese, potato, onion, fries',22.5, 'DessertPlace.jpg', 'VietNam', 'Breakfast', 'This definition includes a range of courses ranging from fruits or dried nuts to multi-ingredient cakes and pies. Many cultures have different variations of dessert', FALSE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (53, 9, 8, 'Dough Tampas', 'Beef, cheese, potato, onion, fries',21.3, 'DoughTampas.jpg', 'VietNam', 'Lunch', 'Description. Meet Dough: a quirky and whimsical bistro and bakery by Datz. This is the place for delicious morning pastries, eclectic lunch, an afterschool snack', FALSE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (7, 2, 7, 'Vegan Eggplant Salad', 'Peppers, garlic, fresh herbs, lemon juice',39.90, 'engg.jpg', 'Viet Nam', 'Dinner', 'Flaming hot oven-roasted eggplant, with mixed peppers, garlic, fresh herbs, lemon juice, and olive oil.', FALSE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (42, 7, 6, 'Fennel Diavolo Pizza', 'Garlic, spicy fennel, calabrese salami, red
onion, mozzarella, fennel pollen,…',10.90, 'fennel-diavolo-pizza.jpg', 'American', 'Snacks', 'Is a pizza that combines many different ingredients and spices to create harmony and give people a delicious pizza.', TRUE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (57, 10, 3, 'Fruit Juice', 'Beef, cheese, potato, onion, fries',25.9, 'FruitJuice.jpg', 'Korean', 'Breakfast', 'Fruit juice is 100% pure juice made from the flesh of fresh fruit or from whole fruit, depending on the type used. It is not permitted to add sugars, sweeteners, preservatives, flavourings or colourings to fruit juice. Fruit juices are usually described as: From concentrate.', TRUE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (39, 7, 3, 'Italian Sausage Pizza', 'Tomato sauce, spicy sausage, smoked
mozzarella, potato, mama Lils peppers,…',9.90, 'italian-sausage-pizza.jpg', 'Korean', 'Lunch', 'An Italian pizza that uses special spicy sausage with mozzarella bacon to create a distinctive spicy flavor and is only suitable for adults and people to eat spicy.', TRUE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
...
1 green bell pepper, chopped (or any color)',38.5, 'LimeVeganTacos.jpg', 'Mexico', 'Dinner', 'The tacos are filled with pinto beans and brown rice simmered in veggie broth and seasonings. The tacos are then slathered in a tangy cilantro-lime sauce and topped with diced onion and fresh cilantro', FALSE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (49, 9, 4, 'Little Bowl', 'Beef, cheese, potato, onion, fries',18.5, 'LittleBowl.jpg', 'VietNam', 'Snacks', 'Very small bowls, such as the tea bowl, are often called cups, while plates with especially deep wells are often called bowls. In many cultures bowls are the most common kind of vessel used for serving and eating food. Historically small bowls were also used for serving both tea and alcoholic drinks.', TRUE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (51, 9, 6, 'Local Desserts', 'Beef, cheese, potato, onion, fries',19.6, 'LocalDesserts.jpg', 'VietNam', 'Breakfast', 'essert is a course that concludes a meal. The course consists of sweet foods, such as ... There is no simple definition of a dessert wine. ... There is widespread use of rice flour in East Asian desserts, which often include local ingredients such ', TRUE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (37, 7, 1, 'Margherita Pizza', 'Tomato sauce, mozzarella cheese and
basil.',9.90, 'margherita-pizza.jpg', 'American', 'Lunch', 'Is a classic American pizza, with traditional American flavor and character', FALSE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (58, 10, 4, 'Matcha Mojito', 'Beef, cheese, potato, onion, fries',28.3, 'MatchaMojito.jpg', 'Korean', 'Dinner', 'Matcha is a green tea made from stone ground tea leaves. Its packed with nutrients and antioxidants, so why not add it to a yummy cocktail? We made a classic mojito recipe, we like them with a lot of mint leaves (you cant go overboard!), lime juice, a little cane sugar and a tablespoon of matcha powder.', FALSE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (60, 10, 6, 'Milk Tea', 'Beef, cheese, potato, onion, fries',26.5, 'MilkTea.jpg', 'Korean', 'Snacks', 'The term ""milk tea"" refers to any tea drink with milk added. It can be as simple as a splash of milk in a hot cup of tea, or it can be a complex recipe including various ingredients, like the popular bubble tea. ... Milk tea is enjoyed throughout the world as both a hot and cold beverage.', FALSE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (13, 3, 4, 'Minced Pork on Rice', 'Rice, Pork, Green onion, Soup',3.90, 'minced-pork-on-rice.jpg', 'China', 'Breakfast', 'Kurobuta pork, soy braised egg, house
pickles, garnished with scallions', TRUE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (41, 7, 5, 'Mushroom Pizza', 'Garlic, fontina, scallion, ricotta, and parmigiano.',12.90, 'mushroom-pizza.jpg', 'Viet Nam', 'Lunch', 'This pizza uses parmigiano mushrooms to create a highlight for the cake, parmigiano mushrooms combined with the leaves to create a special aroma that attracts people to eat.', TRUE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (24, 4, 6, 'Naco Taco', 'Beef, cheese, potato, onion, fries',33.8, 'NacoTaco.jpg', 'Mexico', 'Dinner', 'Food was tasty. Service was awesome, drinks were delicious. The restaurant has dim lighting, the sides are enough to share. I Couldnt have picked a better place to celebrate my birthday. Monday nights seem very low-key', FALSE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (9, 2, 9, 'Vegan Onion Rings', 'onions',29.90, 'onion.jpg', 'Viet Nam', 'Snacks', 'We use real onions and batter them in house.', FALSE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (12, 2, 3, 'Original Acai Bowl', 'granola, fresh banana, blueberries and strawberries',19.90, 'original.jpg', 'Chinese', 'Breakfast', 'Topped off with unsweetened organic coconut chips. ✅ Gluten-free ✅ Vegan ✅ Soy-free ✅ 100% Natural Non-GMO ingredients Allergens: Contains almond, coconut. May contain traces of other tree nuts.', FALSE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (25, 5, 7, 'Original Chicken Sandwich', 'Beef, cheese, potato, onion, fries',19.90, 'OriginalChicken.jpg', 'American', 'Lunch', '2 Original Chicken Sandwiches and 2 Small French Fries', FALSE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (36, 6, 9, 'Mint Pangrattato', 'Red Pepper, San Marzano Tomatoes, Extra Virgin Olive Oil, Salt, Basil',39.59, 'pangratto.jpg', 'American', 'Dinner', 'In Sardinia, you can ask any passerby - albeit in Sardu, the local language - what the secret to the island’s cuisine is and, should you understand the vernacular, they will tell you that the perfect Sardinian dish relies not on elaborate preparation but the use of as few ingredients as possible. Each, however, must be exquisite. ', FALSE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (3, 1, 3, 'Peanut Slaw with Soba Noodles', 'Easily gluten free and easily vegan',29.90, 'Peanut Slaw with Soba Noodles.jpg', 'Viet Nam', 'Snacks', 'I have made this recipe so many times! Mostly for myself, but I have also brought it to a few potluck-style gatherings and it was a hit every time. Super simple to make and very addicting!', TRUE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (17, 3, 8, 'Pork Meat Soup Dumplings', 'Rice flour, char siu, minced pork',3.90, 'porkmeatsoupdumplings.jpg', 'China', 'Breakfast', 'Combo includes 8 char siu dumplings', FALSE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
...
provolone.',10.90, 'repperoni-pizza.jpg', 'ThaiLan', 'Dinner', 'using a special cheese called Pepperoni, n with a special taste gives the eater a new and attractive feeling.', FALSE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (43, 8, 7, 'Salmon Avocado Roll', 'Salmon and avocado',20.90, 'salmon-avocado-roll.jpg', 'Viet Nam', 'Snacks', 'The combination of salmon and avocado creates a rich and creamy sushi dish', TRUE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (47, 8, 2, 'Salmon Sushi', 'Rice and salmon',17.90, 'salmon-sushi.jpg', 'Japan', 'Breakfast', 'Salmon sushi is no longer a strange dish to everyone, a familiar delicious sushi that everyone should try at least once in their life.', TRUE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (20, 4, 2, 'Salt n Lime', 'Beef, cheese, potato, onion, fries',30.5, 'SaltnLime.jpg', 'Mexico', 'Lunch', 'At Salt n Lime we offer clean n safely prepared meals of excellent quality and invite you to try our fresh Mexican n American foods. The key to our success is simple: providing quality consistent food that tastes great every single time', TRUE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (18, 3, 9, 'Shanghai Sauteed Flat Noodle', 'Rice flour, pork, green onion, vegetables, chili, sugar, salt',2.90, 'shanghaisauteedflatnoodle.jpg', 'Viet Nam', 'Dinner', 'Có 2 loại mì kết hợp, loại nhỏ và dai, loại lớn giòn với thịt heo xào tỏi tạo nên sự hấp dẫn.', TRUE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (48, 8, 3, 'Shrimp Tempura Roll', 'Shrimp tempura, avocado and
cucumber roll and Topped with eel sauce.',27.90, 'shrim-tempura-roll.jpg', 'American', 'Snacks', 'Rice roll with shrimp, avocado, cucumber and eel sauce these 4 ingredients work together to create delicious and exotic sushi. 4 unrelated ingredients but when combined to create an unforgettable taste for first time eaters ', TRUE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (16, 3, 7, 'Slack Season Noodles', 'Chicken and pork broth, minced pork, garlic,
shrimp',4.90, 'slack-season-noodles.jpg', 'American', 'Breakfast', 'Chicken and pork sauce combined with minced meat, garlic and shrimp creates a bowl of noodles with a new and attractive flavor.', TRUE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (27, 5, 9, 'SMOKED BACON BRISKET BURGER', 'Certified Angus Beef, smoked aged cheddar cheese, brisket, applewood smoked bacon, pickles, bbq sauce, toasted brioche bun',49.90, 'Smashburger.jpg', 'American', 'Lunch', 'Total Fat 27g,Cholesterol 210mg ,Total Carbohydrate 56g', FALSE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (56, 10, 2, 'Soda', 'Beef, cheese, potato, onion, fries',25.2, 'Soda.jpg', 'USA', 'Dinner', '1 : a powdery substance like salt used in washing and in making glass or soap. 2 : baking soda. 3 : soda water. 4 : soda pop. 5 : a sweet drink made of soda water, flavoring, and often ice cream.', TRUE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (5, 1, 5, 'Spaghetti Squash Burrito Bowls', 'Noodle, Gluten free and easily vegan.',39.90, 'Spaghetti Squash Burrito Bowls.jpg', 'American', 'Snacks', 'I absolutely LOVE this recipe! I made it last night for my family girls night. My 4 year old exclaimed “this is so good mommy!” and “I love this!” once she finally sat still enough to eat more than the purple parts. As for me….just what I needed…fabulous flavor amazing color and pretty fast to prepare for our lenten Friday supper. And my husband was out, so no griping about squash! Wins all the way around.', TRUE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (31, 6, 4, 'Spaghetti with Ramps', 'Ramps, Chilies and Parmesan',39.90, 'Spaghetti.jpg', 'Chinese', 'Breakfast', 'Seafood is a treasured delicacy in Italy, which is no surprise when you think about the expansive coastline stretching from the northern regions of Veneto and Liguria all the way to the southern island of Sicily. From the shores of the Adriatic sea and the glistening marinas that line the Amalfi coast to the bustling ports of the Italian riviera, seafood is freshly prepared everyday in humble, family-run eateries to be enjoyed by locals and holiday-makers alike. In this dish, we pay homage to the time-honoured culinary traditions of Italy’s seaside towns.', FALSE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (6, 1, 6, 'Spicy Sweet Potato', 'Green rice burrito bowls, vegan.',19.90, 'Spicy Sweet Potato.jpg', 'ThaiLan', 'Lunch', 'I made this last night, and my brother-in-law, a devout meat eater, loved it. But more importantly, the vegetarians present loved it. We were all wowed by the combo of textures and flavors: soft, crunchy, hot, cool. The hint of lime in the beans and the seasoned rice were show-stoppers. I am curious to try other flavored rice, but for now, thank you so much for such a wonderful company dish.', TRUE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (44, 8, 8, 'Spicy Tuna Roll', 'tuna and cucumber',28.90, 'spicy-tuna-roll.jpg', 'Japan', 'Dinner', 'Soft tuna and crispy cucumber combine to create a harmonious combination for delicious sushi', FALSE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (21, 4, 3, 'Street Tacos', '2 tablespoons reduced sodium soy sauce
2 tablespoons freshly squeezed lime juice
2 tablespoons canola oil, divided
3 cloves garlic, minced
2 teaspoons chili powder',36.5, 'StreetTacos.jpg', 'Mexico', 'Snacks', 'What are street tacos? Mexican street tacos are smaller tacos, typically served on corn tortillas. They are small in size, making it easier for a “street traveler” to enjoy a quick meal. The filling is served on two small corn tortillas so that they dont rip or tear when piled high with toppings', TRUE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (35, 6, 8, 'Tagliatelle', 'Bolognese Bianco (Chicken, Veal, Pork) and Parmesan',39.90, 'tagliatelle-arrabbiata.jpg', 'Chinese', 'Breakfast', 'In this weeks Italo-Americano special, weve created the ultimate macaroni cheese, transforming a somewhat scorned American staple into something utterly irresistible. To do so, weve called upon a selection of beautiful cheeses from Italy, as well as a sumptuous scattering of gorgeous truffles sourced in Umbria', FALSE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (55, 10, 1, 'US-Beveragee', 'Beef, cheese, potato, onion, fries',30.1, 'US-Beveragee.jpg', 'USA', 'Lunch', 'Non-alcoholic drinks[edit]. Image, Drink Name, Associated Region, Description', TRUE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (8, 2, 8, 'Vegan Potato Salad', 'Potatoes, tomatoes, onions, peppers, herbs, house spices, and olive oil.',49.90, 'vegan.jpg', 'Viet Nam', 'Dinner', 'Potatoes, tomatoes, onions, peppers, herbs, house spices, and olive oil.', FALSE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (10, 2, 1, 'Vegan Hummus with Pita', 'sauce and garlic',39.59, 'VeganHummus.jpg', 'Viet Nam', 'Snacks', 'Creamy garbanzo beans mixed with sesame sauce and garlic.', FALSE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (11, 2, 2, 'Vegan Spicy Falafel Wrap', ' onions, cilantro, parsley, and tahini',39.90, 'Veganpicy.jpg', 'Viet Nam', 'Breakfast', 'Crispy spicy vegan falafel balls served with onions, cilantro, parsley, and tahini, on your choice of wrap.', FALSE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (30, 5, 3, 'Veg Burger', 'Beef, cheese, potato, onion, fries',49.90, 'VegBurger.jpg', 'American', 'Lunch', 'Veg burger,Coca Cola ,French fries', FALSE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (52, 9, 7, 'Vietnamese Ice Cream', 'Beef, cheese, potato, onion, fries',20.2, 'VietnameseIcecream.jpg', 'VietNam', 'Dinner', 'Ice cream (derived from earlier iced cream or cream ice) is a sweetened frozen food typically eaten as a snack or dessert. It may be made from dairy milk or cream and is flavoured with a sweetener, either sugar or an alternative, and any spice, such as cocoa or vanilla', FALSE);
INSERT INTO Products (Id, Product_Category_Id, Restaurant_Id, Name, Ingredients, Price, Image, Country, Tag, Description, Featured)
VALUE (14, 3, 5, 'Wonton Noodle Soup', 'rice flour, vegetables, minced meat, soup',2.90, 'wonton-noodle-soup.jpg', 'Viet Nam', 'Snacks', 'using beef bone broth for hours creates delicious soups and chewy noodles', FALSE);
